(() => {
	...
	const run = async () => {
		try {
			...
			const clickCatcherStyles = document.getElementById('clickCatcherStyles');
			clickCatcherStyles?.parentNode?.removeChild(clickCatcherStyles); 
			removeHiddenImportantClass();
		}
	};
