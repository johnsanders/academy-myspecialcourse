...
/**
 * Display information about all the vimeo modules in the requested course.
 *
 * @package     vimeo
...
$modulenameplural = get_string('modulenameplural', 'vimeo');
echo $OUTPUT->heading($modulenameplural);

$vimeos = get_all_instances_in_course('vimeo', $course);

if (empty($vimeos)) {
    notice(get_string('nonewmodules', 'vimeo'), new moodle_url('/course/view.php', array('id' => $course->id)));
}
